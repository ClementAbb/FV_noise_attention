...
fac_noi <- noise_glm_sim(data.df, ID, fac_filter)
voi_noi <- noise_glm_sim(data.df, ID, voi_filter)
sti_noi <- noise_glm_sim(data.df, ID, sti_filter)
...
```{r 2D, fig.width = 10, fig.height = 10}

scale <- 0:3

opar <- par(mfrow = c(1, 2), mar = c(mar=c(1.1, 3.1, 4.1, 2.1)), mgp = c(1,1,0))

plot(0, type = 'n', xlim = c(0, 3), ylim = c(0,7.5),
     yaxt = 'n', xaxt = 'n',cex.lab = 1.5,
     xlab = '', ylab = "simulated d'", main = 'noise in attended modality')

legend("topleft",
       c("attended no noise", "attended noise", "unattended no noise", "unattended noise"), 
       lty = c(2,1,2,1), col = c("red", "red", "blue", "blue"), lwd = 2, bty = "n",
       x.intersp = 0.5, text.width = 0.01,
       seg.len = 1.5)

abline(h = 0, lty = 3, col = 'black', lwd = 2)
lines(scale, scale * test_noi$scales_ini[2] * 2, col = 'blue', lty = 2, lwd = 3)
lines(scale, scale * test_noi$scales_ini[1] * 2, col = 'red' , lty = 2, lwd = 3)

lines(scale, scale * test_noi$scales_ini[2] * test_noi$scales_noi[ 3] * 2,
      col = 'blue', lty = 1, lwd = 3)
lines(scale, scale * test_noi$scales_ini[1] * test_noi$scales_noi[13] * 2,
      col = 'red' , lty = 1, lwd = 3)
...
lines(scale, scale * test_noi$scales_ini[2] * test_noi$scales_noi[ 7] * 2,
      col = 'blue', lty = 1, lwd = 3)
lines(scale, scale * test_noi$scales_ini[1] * test_noi$scales_noi[17] * 2,
      col = 'red' , lty = 1, lwd = 3)
```

## 2EFG

```{r 2EFG, fig.width = 5, fig.height = 10}
...
lines(1:4,  test_noi$scales_noi[c( 1, 2, 3, 4)], col = 'blue', type = 'b', lwd = 3)
lines(1:4,  test_noi$scales_noi[c(11,12,13,14)], col = 'red',  type = 'b', lwd = 3)
...
lines(1:4,  test_noi$scales_noi[c( 1, 5, 7, 9)], col = 'blue', type = 'b', lwd = 3)
lines(1:4,  test_noi$scales_noi[c(11,15,17,19)], col = 'red',  type = 'b', lwd = 3)
...
lines(1:4,  test_noi$scales_noi[c( 1, 6, 8,10)], col = 'blue', type = 'b', lwd = 3)
lines(1:4,  test_noi$scales_noi[c(11,16,18,20)], col = 'red',  type = 'b', lwd = 3)
```
